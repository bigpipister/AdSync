    ...
    <el-popover :visible="popoverVisible" :width="props.width" placement="bottom-end">
      <template #reference>
        <div @click="popoverVisible = !popoverVisible">
          <slot>
            <el-input v-model="selectedIcon" readonly placeholder="點擊選擇圖標" class="reference">
              <template #prepend>
                <!-- 根據圖標類型展示 -->
      ...
      <div ref="popoverContentRef">
        <el-input v-model="filterText" placeholder="搜索圖標" clearable @input="filterIcons" />
        <el-tabs v-model="activeTab" @tab-click="handleTabClick">
          <el-tab-pane label="SVG 圖標" name="svg">
          ...
          <el-tab-pane label="Element 圖標" name="element">
            <el-scrollbar height="300px">
              <ul class="icon-grid">
                <li
