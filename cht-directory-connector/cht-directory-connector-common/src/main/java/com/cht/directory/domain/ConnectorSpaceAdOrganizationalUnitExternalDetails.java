...
@Entity
@Data
@IdClass(ConnectorSpaceAdOrganizationalUnitExternalDetailsId.class)
@Table(name = "connector_space_ad_organizationalunit_external_details")
public class ConnectorSpaceAdOrganizationalUnitExternalDetails implements Serializable {
