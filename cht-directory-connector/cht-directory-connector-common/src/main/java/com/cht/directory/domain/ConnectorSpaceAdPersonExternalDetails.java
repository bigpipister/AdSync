...
@Entity
@Data
@IdClass(ConnectorSpaceAdPersonExternalDetailsId.class)
@Table(name = "connector_space_ad_person_external_details")
public class ConnectorSpaceAdPersonExternalDetails implements Serializable {
