...
@Entity
@Data
@IdClass(ConnectorSpaceAdOrganizationalUnitSyncDetailsId.class)
@Table(name = "connector_space_ad_organizationalunit_sync_details")
public class ConnectorSpaceAdOrganizationalUnitSyncDetails implements Serializable {
