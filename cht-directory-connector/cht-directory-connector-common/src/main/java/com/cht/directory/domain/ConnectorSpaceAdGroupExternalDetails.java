...
@Entity
@Data
@IdClass(ConnectorSpaceAdGroupExternalDetailsId.class)
@Table(name = "connector_space_ad_group_external_details")
public class ConnectorSpaceAdGroupExternalDetails implements Serializable {

    public ConnectorSpaceAdGroupExternalDetails() {
