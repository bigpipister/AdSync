...
--changeset tsunghsien:002


create table if not exists connector_space_ad_organizationalunit_sync_details
(
...
create table if not exists connector_space_ad_group_sync_details
(
    placeholder          varchar(256) not null,
    dn                   varchar(256),
    objectguid           varchar(256) not null,
...
create table if not exists connector_space_ad_person_sync_details
(
