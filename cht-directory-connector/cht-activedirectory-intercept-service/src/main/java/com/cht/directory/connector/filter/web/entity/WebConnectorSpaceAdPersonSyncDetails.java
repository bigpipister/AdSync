...
@Entity
@Data
@IdClass(WebConnectorSpaceAdPersonSyncDetailsId.class)
@Table(name = "connector_space_ad_person_sync_details")
public class WebConnectorSpaceAdPersonSyncDetails implements Serializable {
