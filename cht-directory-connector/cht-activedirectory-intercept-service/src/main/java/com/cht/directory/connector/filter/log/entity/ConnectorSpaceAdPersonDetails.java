package com.cht.directory.connector.filter.log.entity;
...
@Entity
@Data
@IdClass(ConnectorSpaceAdPersonDetailsId.class)
@Table(name = "connector_space_ad_person_details")
public class ConnectorSpaceAdPersonDetails implements Serializable {
