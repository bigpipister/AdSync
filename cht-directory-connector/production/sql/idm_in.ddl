...
-- DROP TABLE inidm.connector_space_ad_organizationalunit_details;

CREATE TABLE inidm.connector_space_ad_organizationalunit_details (
...
-- DROP TABLE inidm.connector_space_ad_group_details;

CREATE TABLE inidm.connector_space_ad_group_details (
	placeholder varchar(256) NOT NULL,
    displayname varchar(2048) NULL,
...
-- DROP TABLE inidm.connector_space_ad_person_details;

CREATE TABLE inidm.connector_space_ad_person_details (
...
-- DROP TABLE inidm.connector_space_ad_organizationalunit_sync_details;

CREATE TABLE inidm.connector_space_ad_organizationalunit_sync_details (
    displayname varchar(2048) NULL,
    ou varchar(256) NOT NULL,
    dn varchar(256) NULL,
    objectguid varchar(256) NOT NULL,
...
-- DROP TABLE inidm.connector_space_ad_group_sync_details;

CREATE TABLE inidm.connector_space_ad_group_sync_details (
    placeholder varchar(256) NOT NULL,
    displayname varchar(2048) NULL,
    dn varchar(256) NOT NULL,
    objectguid varchar(256) NOT NULL,
...
-- DROP TABLE inidm.connector_space_ad_person_sync_details;

CREATE TABLE inidm.connector_space_ad_person_sync_details (
    employeeid varchar(256) NULL,
    useraccountcontrol int4 NULL,
    userparameters varchar(256) NULL,
    sn varchar(256) NULL,
...
-- DROP TABLE inidm.databasechangelog;

CREATE TABLE inidm.databasechangelog (
...
-- DROP TABLE inidm.databasechangeloglock;

CREATE TABLE inidm.databasechangeloglock (
	id int4 NOT NULL,
...
-- DROP TABLE inidm.audit_logs;

CREATE TABLE inidm.audit_logs (
...
-- DROP TABLE inidm.status_logs;

CREATE TABLE inidm.status_logs (
...
-- DROP TABLE inidm.event_logs;

CREATE TABLE inidm.event_logs (
    region varchar(256) NOT NULL,
    jobname varchar(256) NOT NULL,
    dn varchar(256) NOT NULL,
